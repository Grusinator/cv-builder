...
\cvevent{Data Engineer}{Clever}{April 2024 -- May 2024}{Copenhagen, Denmark}
Even though it turned out to be a cultural mismatch, i decided to include it in my CV, because i think it has still contributed to my understanding, especially in terms of understanding databricks technologies like unity catalog, and how it can play together with devops tools like terraform, how to test and develop.

\cvtag{python} \cvtag{pyspark} \cvtag{databricks} \cvtag{terraform} \cvtag{unity catalog} \cvtag{devops} \cvtag{azure devops} \cvtag{SCRUM}
\divider

\cvevent{Data Engineer}{Energinet}{December 2022 -- October 2023}{Fredericia, Denmark}
...
\cvtag{python} \cvtag{spark} \cvtag{databricks} \cvtag{GDB} \cvtag{DFSU} \cvtag{segy} \cvtag{xtf} \cvtag{sedona} \cvtag{geospark} \cvtag{parquet} \cvtag{geohashing} \cvtag{deltalake} \cvtag{azure devops} \cvtag{SCRUM}
\divider
